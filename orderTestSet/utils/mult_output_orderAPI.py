...
class mult_output_orderAPI:
    def __init__(self,jsonfilename):
        currentPathName,parentPathName=mult_output_orderAPI.getJsonFilePath()
            ...
            for ins in input:
                ...
                try:
                    ...
                    if ins["type"]=="input":
                        ...
                        self.outputResult[ins["name"]]=output
                    else:
                        print("json 结构输出错误")

                except:
                     print "测试失败：请检查ip、端口是否正确"
            return self.inputResult,self.outputResult
